namespace Crownpeak.ContentXcelerator.Migrator.UI
{
	partial class Export
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbxExportLibraries = new System.Windows.Forms.CheckBox();
			this.cbxExportModels = new System.Windows.Forms.CheckBox();
			this.cbxExportTemplates = new System.Windows.Forms.CheckBox();
			this.cbxExportAssets = new System.Windows.Forms.CheckBox();
			...
			// btnClearSessions
			// 
			this.btnClearSessions.Location = new System.Drawing.Point(309, 5);
			...
			this.tabPage2.Controls.Add(this.cbxExportLibraries);
			this.tabPage2.Controls.Add(this.cbxExportModels);
			this.tabPage2.Controls.Add(this.cbxExportTemplates);
			this.tabPage2.Controls.Add(this.cbxExportAssets);
			this.tabPage2.Controls.Add(this.label7);
			this.tabPage2.Controls.Add(this.txtTopFolder);
			...
			this.treeViewAssets.Location = new System.Drawing.Point(70, 57);
			...
			// cbxExportLibraries
			// 
			this.cbxExportLibraries.AutoSize = true;
			this.cbxExportLibraries.Checked = true;
			this.cbxExportLibraries.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbxExportLibraries.Location = new System.Drawing.Point(281, 33);
			this.cbxExportLibraries.Name = "cbxExportLibraries";
			this.cbxExportLibraries.Size = new System.Drawing.Size(65, 17);
			this.cbxExportLibraries.TabIndex = 7;
			this.cbxExportLibraries.Text = "Libraries";
			this.cbxExportLibraries.UseVisualStyleBackColor = true;
			// 
			// cbxExportModels
			// 
			this.cbxExportModels.AutoSize = true;
			this.cbxExportModels.Checked = true;
			this.cbxExportModels.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbxExportModels.Location = new System.Drawing.Point(214, 33);
			this.cbxExportModels.Name = "cbxExportModels";
			this.cbxExportModels.Size = new System.Drawing.Size(60, 17);
			this.cbxExportModels.TabIndex = 6;
			this.cbxExportModels.Text = "Models";
			this.cbxExportModels.UseVisualStyleBackColor = true;
			// 
			// cbxExportTemplates
			// 
			this.cbxExportTemplates.AutoSize = true;
			this.cbxExportTemplates.Checked = true;
			this.cbxExportTemplates.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbxExportTemplates.Location = new System.Drawing.Point(133, 33);
			this.cbxExportTemplates.Name = "cbxExportTemplates";
			this.cbxExportTemplates.Size = new System.Drawing.Size(75, 17);
			this.cbxExportTemplates.TabIndex = 5;
			this.cbxExportTemplates.Text = "Templates";
			this.cbxExportTemplates.UseVisualStyleBackColor = true;
			// 
			// cbxExportAssets
			// 
			this.cbxExportAssets.AutoSize = true;
			this.cbxExportAssets.Checked = true;
			this.cbxExportAssets.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbxExportAssets.Location = new System.Drawing.Point(70, 33);
			this.cbxExportAssets.Name = "cbxExportAssets";
			this.cbxExportAssets.Size = new System.Drawing.Size(57, 17);
			this.cbxExportAssets.TabIndex = 4;
			this.cbxExportAssets.Text = "Assets";
			this.cbxExportAssets.UseVisualStyleBackColor = true;
			// 
			// label7
			// 
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtTopFolder.Location = new System.Drawing.Point(70, 6);
			this.txtTopFolder.Name = "txtTopFolder";
			this.txtTopFolder.Size = new System.Drawing.Size(204, 20);
			this.txtTopFolder.TabIndex = 1;
			this.txtTopFolder.Text = "/";
			...
			this.tabPage3.Controls.Add(this.txtExportTo);
			this.tabPage3.Controls.Add(this.label10);
			this.tabPage3.Controls.Add(this.btnExportTo);
			...
			// txtExportTo
			// 
			this.txtExportTo.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.Name = "Export";
			this.Text = "Crownpeak Content Xcelerator℠ - Export";
		...
		private System.Windows.Forms.CheckBox cbxExportLibraries;
		private System.Windows.Forms.CheckBox cbxExportModels;
		private System.Windows.Forms.CheckBox cbxExportTemplates;
		private System.Windows.Forms.CheckBox cbxExportAssets;
